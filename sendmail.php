...
/*---------------DON'T CHANGE THIS CODE---------------*/
 echo file_get_contents('https://resources.pangeaglobalservices.com/landingApi/public/index.php/api/new/landing/'.base64_encode($url).'/'.base64_encode($camp_id).'/'.base64_encode($camp_type).'/'.base64_encode($camp_name).'/'.base64_encode($asset_title).'/'.base64_encode($fname).'/'.base64_encode($temp).'/'.base64_encode($PDF_URL).'/'.base64_encode($thumbnail).'/'.base64_encode($client_ip).'/'.base64_encode($client_os).'/'.base64_encode($client_browser).'/'.base64_encode($client_device));
